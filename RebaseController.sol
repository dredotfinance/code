...
contract RebaseController is DreAccessControlled {
    ...
    function initialize(IDRE _dre, ITreasury _treasury, IDreStaking _staking, IDreAuthority _authority)
        public
        initializer
    {
        dre = _dre;
    ...
    function projectedEpochRateRaw(uint256 pcvUsd, uint256 supply) public pure returns (uint256 apr, uint256 epochRate, uint256 backingRatio) {
